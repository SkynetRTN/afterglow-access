      ...
      function c(e) {
        return (
          e.each(function (c, e) {
            ...
            J.append("rect").attr("class", "nv-measure"), H.attr("transform", "translate(" + d.left + "," + d.top + ")");
            for (
              var N = function (a) {
          ...
          m.each(function (b) {
            ...
            var F = E.enter()
              ...
              .on("click", function (a, b) {
                var c = this;
                v.elementClick({ data: a, index: b, color: d3.select(this).style("fill"), event: d3.event, element: c }),
        ...
        return (
          ...
          F.each(function (b) {
            ...
            R.style("fill", function (a, b, c) {
              ...
              .on("click", function (a, b) {
                var c = this;
                C.elementClick({ data: a, index: b, color: d3.select(this).style("fill"), event: d3.event, element: c }),
                  d3.event.stopPropagation();
              })
              .on("dblclick", function (a, b) {
          ...
          m.each(function (b) {
            ...
            M.append("rect")
              ...
              L.on("mouseover", function (a, b) {
                ...
                .on("click", function (a, b) {
                  var c = this;
                  E.elementClick({ data: a, index: b, color: d3.select(this).style("fill"), event: d3.event, element: c }),
                    d3.event.stopPropagation();
                })
                .on("dblclick", function (a, b) {
          ...
          B.each(function (b) {
            ...
            function B(a) {
              s.forEach(function (b) {
                ...
                b.hasOnlyNaN &&
                  (b.extent[1] =
                    ((l[b.dimension].domain()[1] - c[0]) * (b.extent[1] - b.extent[0])) / (N[b.dimension] - b.extent[0]) +
                    c[0]),
            ...
            p.forEach(function (a) {
              ...
              0 !== f.length &&
                (e
                  ...
                  : f[0].hasNaN && ((d = d < f[0].extent[1] ? f[0].extent[1] : d), (N[a] = l[a].domain()[1]), (O = !0))),
                (l[a] = d3.scale
                  .linear()
                  .domain([c, d])
                  .range([0.9 * (j - 12), 0])),
          ...
          k.each(function (k) {
            ...
            if (r) {
              ...
              h.width(X),
                ...
                h.height() > m.top && ((m.top = h.height()), (R = a.utils.availableHeight(o, P, m) - (v ? l.height() : 0))),
          ...
          f.each(function (f) {
            ...
            h[0][0]
              ...
              : (h = v
                  ...
                  .attr("transform", "translate(" + (m / 2 + p.left + p.right) + "," + (n / 2 + p.top + p.bottom) + ")")),
