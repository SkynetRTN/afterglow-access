...
!(function () {
  ...
  (a.dev = !1),
    ...
    (a.logs = {}),
    (a.dom = {}),
    'undefined' != typeof module && 'undefined' != typeof exports && 'undefined' == typeof d3 && (d3 = require('d3')),
        ...
        l.each(function (l) {
          function m() {
            ...
            g.elementMousemove({ mouseX: d, mouseY: e, pointXValue: m }),
              'dblclick' === d3.event.type && g.elementDblclick({ mouseX: d, mouseY: e, pointXValue: m }),
              'click' === d3.event.type && g.elementClick({ mouseX: d, mouseY: e, pointXValue: m }),
              'mousedown' === d3.event.type && g.elementMouseDown({ mouseX: d, mouseY: e, pointXValue: m }),
              'mouseup' === d3.event.type && g.elementMouseUp({ mouseX: d, mouseY: e, pointXValue: m });
          }
        ...
        return (
          ...
          g.each(function (b) {
            ...
            null !== n
              ...
              u.watchTransition(t, 'axis').call(c),
              (s = s || c.scale());
            var v = c.tickFormat();
            ...
            switch (c.orient()) {
              case 'top':
                w.enter().append('text').attr('class', 'nv-axislabel'),
                  ...
                  1 === d.range().length
                    ...
                    : 2 === d.range().length
                    ? (z = m ? d.range()[0] + d.range()[1] + d.rangeBand() : d.range()[1])
                    : d.range().length > 2 && (z = d.range()[d.range().length - 1] + (d.range()[1] - d.range()[0])),
                  w
                    .attr('text-anchor', 'middle')
                    .attr('y', 0)
                    .attr('x', z / 2),
                  i &&
                    ((y = q.selectAll('g.nv-axisMaxMin').data(d.domain())),
                    y
                      .enter()
                      .append('g')
              ...
              case 'bottom':
                ...
                if (j % 360) {
                  ...
                  (x = (E ? E * A : A) + 30),
                    C.attr('transform', D).style('text-anchor', j % 360 > 0 ? 'start' : 'end');
                } else
                  l
                ...
                w.enter().append('text').attr('class', 'nv-axislabel'),
                  ...
                  w
                    ...
                    .attr('x', z / 2),
                  i &&
                    ((y = q.selectAll('g.nv-axisMaxMin').data([d.domain()[0], d.domain()[d.domain().length - 1]])),
                    y
                      .enter()
                      .append('g')
                      .attr('class', function (a, b) {
              ...
              case 'right':
                w.enter().append('text').attr('class', 'nv-axislabel'),
                  ...
                  i &&
                    ...
                    y
                      .watchTransition(t, 'min-max right')
                      .attr('transform', function (b, c) {
            ...
            if (
              ...
              !i ||
                ...
                d.domain()[0] == d.domain()[1] &&
                  0 == d.domain()[0] &&
                  q.selectAll('g.nv-axisMaxMin').style('opacity', function (a, b) {
                    return b ? 0 : 1;
                  })),
      ...
      function b(l) {
        return (
          ...
          l.each(function (b) {
            ...
            var N = function () {
                return null === D ? 0.9 * m.rangeBand() : Math.min(75, 0.9 * m.rangeBand());
              },
              O = function () {
                ...
                M.selectAll('.nv-boxplot-' + b)
                  .on('mouseover', function (b, c, d) {
                    d3.select(this).classed('hover', !0),
                      B.elementMouseover({ series: { key: a(b), color: u(b) || z(b, d) }, e: d3.event });
                  })
                  .on('mouseout', function (b, c, d) {
                    d3.select(this).classed('hover', !1),
                      B.elementMouseout({ series: { key: a(b), color: u(b) || z(b, d) }, e: d3.event });
                  })
            ...
            Q.enter()
              ...
              .on('mouseover', function (a, b, c) {
                d3.select(this).classed('hover', !0),
                  B.elementMouseover({ series: { key: x(a, b, c), color: y(a, b, c) || z(a, c) }, e: d3.event });
              })
              .on('mouseout', function (a, b, c) {
                d3.select(this).classed('hover', !1),
                  B.elementMouseout({ series: { key: x(a, b, c), color: y(a, b, c) || z(a, c) }, e: d3.event });
              })
              .on('mousemove', function (a, b) {
                B.elementMousemove({ e: d3.event });
              }),
      ...
      function c(e) {
        return (
          e.each(function (c, e) {
            ...
            var y = g.call(this, c, e).slice(),
              z = h.call(this, c, e).slice(),
              A = i.call(this, c, e).slice().sort(d3.descending),
              B = j.call(this, c, e).slice(),
              C = k.call(this, c, e).slice(),
              D = l.call(this, c, e).slice(),
              E = m.call(this, c, e).slice(),
              F = n.call(this, c, e).slice();
            b(C, y), b(D, z), b(E, A), b(F, B), y.sort(d3.descending), z.sort(d3.descending), B.sort(d3.descending);
            var G = d3.scale
              .linear()
            ...
            this.__chart__ = G;
            for (
              var H = (d3.min(y), d3.max(y), y[1], r.selectAll('g.nv-wrap.nv-bullet').data([c])),
                I = H.enter().append('g').attr('class', 'nvd3 nv-wrap nv-bullet'),
                J = I.append('g'),
                K = H.select('g'),
                e = 0,
                L = y.length;
            ...
            K.select('rect.nv-measure')
              ...
              .on('mouseover', function () {
                u.elementMouseover({ value: B[0], label: F[0] || 'Current', color: d3.select(this).style('fill') });
              })
              .on('mousemove', function () {
                u.elementMousemove({ value: B[0], label: F[0] || 'Current', color: d3.select(this).style('fill') });
              })
              .on('mouseout', function () {
                u.elementMouseout({ value: B[0], label: F[0] || 'Current', color: d3.select(this).style('fill') });
              });
            var Q = x / 6,
              R = z.map(function (a, b) {
            ...
            J.selectAll('path.nv-markerLine')
              ...
              H.selectAll('.nv-range')
                ...
                .on('mousemove', function () {
                  u.elementMousemove({ value: B[0], label: F[0] || 'Previous', color: d3.select(this).style('fill') });
                })
                .on('mouseout', function (a, b) {
                  var c = C[b] || v[b];
        ...
        return (
          x.each(function (b) {
            ...
            l.domain(d || d3.extent(b[0].values.map(n).concat(t))),
              ...
              m
                .domain(e || [d3.min(b[0].values.map(s).concat(u)), d3.max(b[0].values.map(r).concat(u))])
                .range(g || [y, 0]),
        ...
        return (
          ...
          l.each(function (l) {
            ...
            if (
              ...
              var O;
              z = {};
              for (O in y) y[O] instanceof Array ? (z[O] = y[O].slice(0)) : (z[O] = y[O]);
            }
            var P = d3.behavior.drag().on('dragstart', A).on('drag', E).on('dragend', H);
            if (
              !(
                l &&
                l.length &&
            ...
            var l = c(G.i, l),
              ...
              U = T.enter().append('g').attr('class', 'nvd3 nv-wrap nv-cumulativeLine').append('g'),
              V = T.select('g');
            if (
              (U.append('g').attr('class', 'nv-interactive'),
              U.append('g').attr('class', 'nv-x nv-axis').style('pointer-events', 'none'),
              U.append('g').attr('class', 'nv-y nv-axis'),
              U.append('g').attr('class', 'nv-background'),
              U.append('g').attr('class', 'nv-linesWrap').style('pointer-events', S),
              U.append('g').attr('class', 'nv-avgLinesWrap').style('pointer-events', 'none'),
              U.append('g').attr('class', 'nv-legendWrap'),
              U.append('g').attr('class', 'nv-controlsWrap'),
              q
                ? (i.width(M),
                  V.select('.nv-legendWrap').datum(l).call(i),
                  i.height() > m.top && ((m.top = i.height()), (N = a.utils.availableHeight(p, L, m))),
                  V.select('.nv-legendWrap').attr('transform', 'translate(0,' + -m.top + ')'))
              ...
              j
                ...
                V.select('.nv-controlsWrap')
                  ...
                  .call(j);
            } else V.select('.nv-controlsWrap').selectAll('*').remove();
            T.attr('transform', 'translate(' + m.left + ',' + m.top + ')'),
              t && V.select('.nv-y.nv-axis').attr('transform', 'translate(' + M + ',0)');
            ...
            T.select('.tempDisabled').remove(),
              ...
              v &&
                (k.width(M).height(N).margin({ left: m.left, top: m.top }).svgContainer(L).xScale(d),
                T.select('.nv-interactive').call(k)),
              U.select('.nv-background').append('rect'),
              V.select('.nv-background rect').attr('width', M).attr('height', N),
              f
                .y(function (a) {
                  return a.display.y;
                })
            ...
            var Y = V.select('.nv-linesWrap').datum(
              l.filter(function (a) {
            ...
            aa
              ...
              r &&
                (g
                  ...
                  .tickSize(-N, 0),
                V.select('.nv-x.nv-axis').attr('transform', 'translate(0,' + e.range()[0] + ')'),
              ...
              C.on('changeState', function (a) {
                'undefined' != typeof a.disabled &&
                  ...
                  'undefined' != typeof a.index && ((G.i = a.index), (G.x = F(G.i)), (y.index = a.index), aa.data([G])),
        ...
        return (
          ...
          i.each(function (i) {
            ...
            z.append('g').attr('class', 'nv-x nv-axis'),
              z.append('g').attr('class', 'nv-y nv-axis').append('g').attr('class', 'nv-zeroLine').append('line'),
              z.append('g').attr('class', 'nv-barsWrap'),
              z.append('g').attr('class', 'nv-legendWrap'),
              B.attr('transform', 'translate(' + j.left + ',' + j.top + ')'),
              n
                ? (h.width(u),
                  B.select('.nv-legendWrap').datum(i).call(h),
                  h.height() > j.top && ((j.top = h.height()), (x = a.utils.availableHeight(l, m, j))),
                  y.select('.nv-legendWrap').attr('transform', 'translate(0,' + -j.top + ')'))
                : B.select('.nv-legendWrap').selectAll('*').remove(),
              q && B.select('.nv-y.nv-axis').attr('transform', 'translate(' + u + ',0)'),
              e.width(u).height(x);
            var C = B.select('.nv-barsWrap').datum(
              i.filter(function (a) {
                return !a.disabled;
              })
            );
            if (
              ...
              r &&
                D.selectAll('text').attr('transform', function (a, b, c) {
                  return 'translate(0,' + (c % 2 == 0 ? '5' : '17') + ')';
                }),
                t &&
                ...
                s && B.selectAll('.tick text').call(a.utils.wrapTicks, b.xAxis.rangeBand());
            }
            p &&
              (g
                .scale(d)
          ...
          x.renderEnd('discreteBar chart immediate'),
          b
        );
      }
      var c,
      ...
      function c(t) {
        return (
          ...
          t.each(function (s) {
            ...
            function u() {
              h.empty() || h.extent(p),
                D.data([h.empty() ? d.domain() : p]).each(function (a, b) {
            ...
            function v() {
              ...
              Math.abs(a[0] - a[1]) <= 1 || (r.brush({ extent: a, brush: h }), u(), r.onBrush(a));
            }
            ...
            var z = w.selectAll('g.nv-focus').data([s]),
              A = z.enter().append('g').attr('class', 'nvd3 nv-focus').append('g'),
              B = z.select('g');
            z.attr('transform', 'translate(' + i.left + ',' + i.top + ')'),
              ...
              o && B.select('.nv-y.nv-axis').attr('transform', 'translate(' + x + ',0)'),
              B.select('.nv-background rect').attr('width', x).attr('height', y),
              b
                .width(x)
                .height(y)
                .color(
            ...
            var C = B.select('.nv-contentWrap').datum(
              s.filter(function (a) {
                return !a.disabled;
              })
            );
            d3.transition(C).call(b),
              h.x(d).on('brush', function () {
                v();
              }),
              p && h.extent(p);
            var D = B.select('.nv-brushBackground')
                .selectAll('g')
                .data([p || h.extent()]),
              E = D.enter().append('g');
            E.append('rect').attr('class', 'left').attr('x', 0).attr('y', 0).attr('height', y),
              E.append('rect').attr('class', 'right').attr('x', 0).attr('y', 0).attr('height', y);
            var F = B.select('.nv-x.nv-brush').call(h);
            F.selectAll('rect').attr('height', y),
              F.selectAll('.resize').append('path').attr('d', t),
              v(),
              B.select('.nv-background rect').attr('width', x).attr('height', y),
              m &&
                (f
                  ...
                  .tickSize(-y, 0),
                B.select('.nv-x.nv-axis').attr('transform', 'translate(0,' + e.range()[0] + ')'),
          ...
          r.each(function (b) {
            ...
            if (j) {
              ...
              y.attr('transform', function (a, b) {
                ...
                l
                  ? w.attr('transform', 'translate(' + (d - c.right - F) + ',' + c.top + ')')
        ...
        return (
          b.each(function (k) {
            ...
            if (
              ...
              var C;
              v = {};
              for (C in u) u[C] instanceof Array ? (v[C] = u[C].slice(0)) : (v[C] = u[C]);
            }
            if (
              !(
                k &&
            ...
            var D = w.selectAll('g.nv-wrap.nv-historicalBarChart').data([k]),
              E = D.enter().append('g').attr('class', 'nvd3 nv-wrap nv-historicalBarChart').append('g'),
              F = D.select('g');
            E.append('g').attr('class', 'nv-x nv-axis'),
              ...
              p
                ? (i.width(A),
                  F.select('.nv-legendWrap').datum(k).call(i),
                  i.height() > l.top && ((l.top = i.height()), (B = a.utils.availableHeight(o, w, l))),
                  D.select('.nv-legendWrap').attr('transform', 'translate(0,' + -l.top + ')'))
                : F.select('.nv-legendWrap').selectAll('*').remove(),
              D.attr('transform', 'translate(' + l.left + ',' + l.top + ')'),
              s && F.select('.nv-y.nv-axis').attr('transform', 'translate(' + A + ',0)'),
              t &&
                (j.width(A).height(B).margin({ left: l.left, top: l.top }).svgContainer(w).xScale(d),
            ...
            var G = F.select('.nv-barsWrap').datum(
              k.filter(function (a) {
                return !a.disabled;
              })
            );
            G.transition().call(f),
              q &&
                (g
                  ...
                  .tickSize(-B, 0),
                F.select('.nv-x.nv-axis').attr('transform', 'translate(0,' + e.range()[0] + ')'),
              ...
              i.dispatch.on('legendClick', function (a, d) {
                (a.disabled = !a.disabled),
                  k.filter(function (a) {
                    ...
                    k.map(function (a) {
                      return (a.disabled = !1), D.selectAll('.nv-series').classed('disabled', !1), a;
                    }),
                  (u.disabled = k.map(function (a) {
                    return !!a.disabled;
                  })),
      ...
      function b(r) {
        ...
        return (
          r.each(function (b) {
            ...
            if ('classic' == q)
              B.append('circle').style('stroke-width', 2).attr('class', 'nv-legend-symbol').attr('r', 5),
            ...
            if (j) {
              ...
              A.attr('transform', function (a, b) {
                ...
                l
                  ? x.attr('transform', 'translate(' + (d - c.right - E) + ',' + c.top + ')')
              ...
              A.attr('transform', function (a, b) {
                ...
                x.attr('transform', 'translate(' + (d - c.right - P) + ',' + c.top + ')'),
            ...
            if ('furious' == q) {
              y
                ...
                .attr('y', -9)
                .attr('x', -15),
                w.insert('rect', ':first-child').attr('class', 'nv-legend-bg').attr('fill', '#eee').attr('opacity', 0);
    ...
    (a.models.lineChart = function () {
      ...
      function b(j) {
        return (
          ...
          j.each(function (j) {
            function y() {
              r && L.select('.nv-focus .nv-x.nv-axis').transition().duration(A).call(f);
            }
            function B() {
              s && L.select('.nv-focus .nv-y.nv-axis').transition().duration(A).call(g);
            }
            function E(a) {
              var b = L.select('.nv-focus .nv-linesWrap').datum(
                j
                  .filter(function (a) {
                    return !a.disabled;
                  })
            ...
            if (
              ((b.update = function () {
                0 === A ? F.call(b) : F.transition().duration(A).call(b);
              }),
              (b.container = this),
              w.setter(D(j), b.update).getter(C(j)).update(),
              (w.disabled = j.map(function (a) {
                return !!a.disabled;
              })),
              !x)
            ) {
            ...
            var J = F.selectAll('g.nv-wrap.nv-lineChart').data([j]),
              K = J.enter().append('g').attr('class', 'nvd3 nv-wrap nv-lineChart').append('g'),
              L = J.select('g');
            ...
            p
              ? (h.width(G),
                ...
                'bottom' === q
                  ? J.select('.nv-legendWrap').attr('transform', 'translate(0,' + H + ')')
                  : 'top' === q &&
                    (h.height() > l.top &&
                      ((l.top = h.height()), (H = a.utils.availableHeight(o, F, l) - (v ? k.height() : 0))),
                    J.select('.nv-legendWrap').attr('transform', 'translate(0,' + -l.top + ')')))
              : L.select('.nv-legendWrap').selectAll('*').remove(),
              J.attr('transform', 'translate(' + l.left + ',' + l.top + ')'),
              t && L.select('.nv-y.nv-axis').attr('transform', 'translate(' + G + ',0)'),
              u &&
                (i.width(G).height(H).margin({ left: l.left, top: l.top }).svgContainer(F).xScale(c),
                J.select('.nv-interactive').call(i)),
              L.select('.nv-focus .nv-background rect').attr('width', G).attr('height', H),
              e
                .width(G)
                .height(H)
                .color(
            ...
            var N = L.select('.nv-linesWrap').datum(
              j.filter(function (a) {
                return !a.disabled;
              })
            );
            if (
              ...
              s &&
                g
                  ...
                  .tickSize(-G, 0),
              L.select('.nv-focus .nv-x.nv-axis').attr('transform', 'translate(0,' + H + ')'),
              v)
            ) {
              k.width(G),
                L.select('.nv-focusWrap')
                  .attr('transform', 'translate(0,' + (H + l.bottom + k.margin().top) + ')')
                  .datum(
                    j.filter(function (a) {
                      return !a.disabled;
                    })
                ...
                if (
                  (j
                    ...
                    .forEach(function (g, i) {
                      var j = v ? (k.brush.empty() ? k.xScale().domain() : k.brush.extent()) : c.domain(),
                      ...
                      null !== q && e.highlightPoint(g.seriesIndex, h, !0),
                        void 0 !== p &&
                          ...
                          n.push({ key: g.key, value: q, color: m(g, g.seriesIndex), data: p }));
                    }),
                  n.length > 2)
                ) {
          ...
          B.renderEnd('lineChart immediate'),
          b
        );
      }
      var c,
        ...
        x = null,
        y = null,
        z = d3.dispatch('tooltipShow', 'tooltipHide', 'stateChange', 'changeState', 'renderEnd'),
        A = 250;
        ...
        (b._options = Object.create(
          {},
          {
            ...
            focusMargin: {
              ...
              set: function (a) {
                (k.margin.top = void 0 !== a.top ? a.top : k.margin.top),
                  ...
                  (k.margin.bottom = void 0 !== a.bottom ? a.bottom : k.margin.bottom),
            ...
            useInteractiveGuideline: {
              ...
              set: function (a) {
                (u = a), u && (e.interactive(!1), e.useVoronoi(!1));
              },
            },
          }
        )),
        ...
        return (
          v.each(function (v) {
            ...
            function S() {
              ...
              var b = fa.select('.nv-focus .nv-barsWrap').datum(
                  _.length
                    ? _.map(function (a, b) {
                        return {
                          key: a.key,
                ...
                h = fa.select('.nv-focus .nv-linesWrap').datum(
                  V(aa)
                    ? [{ values: [] }]
                    : aa
                        .filter(function (a) {
              ...
              (d = _.length && !Q ? l.xScale() : j.xScale()),
                n
                  .scale(d)
                  ._ticks(a.utils.calcTicksX(X / 100, v))
                  .tickSize(-Y, 0),
                ...
                fa.select('.nv-focus .nv-x.nv-axis').attr('transform', 'translate(0,' + f.range()[0] + ')'),
                p
                  .scale(f)
                  ._ticks(a.utils.calcTicksY(Y / 36, v))
                  .tickSize(-X, 0),
                q.scale(g)._ticks(a.utils.calcTicksY(Y / 36, v)),
                Q ? q.tickSize(aa.length ? 0 : -X, 0) : q.tickSize(_.length ? 0 : -X, 0);
              var i = _.length ? 1 : 0,
              ...
              fa.select('.nv-focus .nv-y1.nv-axis').style('opacity', m),
                ...
                fa.select('.nv-focus .nv-y1.nv-axis').transition().duration(L).call(p),
                fa.select('.nv-focus .nv-y2.nv-axis').transition().duration(L).call(q);
            }
            var W = d3.select(this);
            a.utils.initSVG(W);
            ...
            if (
              ...
              (b.container = this),
              M.setter(U(v), b.update).getter(T(v)).update(),
            ...
            (d = _.length && !Q ? l.xScale() : j.xScale()),
              (e = o.scale()),
              (f = Q ? j.yScale() : l.yScale()),
              (g = Q ? l.yScale() : j.yScale()),
              (h = Q ? k.yScale() : m.yScale()),
              (i = Q ? m.yScale() : k.yScale());
            var ba = v
                .filter(function (a) {
            ...
            d.range([0, X]),
              e
                .domain(
                  d3.extent(d3.merge(ba.concat(ca)), function (a) {
                    return a.x;
                  })
                )
                .range([0, X]);
            ...
            if (
              ...
              ha.append('g').attr('class', 'nv-x nv-brush'),
              D)
            ) {
                  ...
                  .datum(
                    v.map(function (a) {
                      return (
                        ...
                        Q ? (a.key = a.originalKey + (a.bar ? P : O)) : (a.key = a.originalKey + (a.bar ? O : P)),
                        a
                      );
                    })
                  )
                  .call(t),
                t.height() > w.top && ((w.top = t.height()), (Y = a.utils.availableHeight(z, W, w) - H)),
                fa.select('.nv-legendWrap').attr('transform', 'translate(' + ja + ',' + -w.top + ')');
            } else fa.select('.nv-legendWrap').selectAll('*').remove();
            ...
            var ka = fa.select('.nv-context .nv-barsWrap').datum(_.length ? _ : [{ values: [] }]),
              la = fa.select('.nv-context .nv-linesWrap').datum(
                V(aa)
                  ? [{ values: [] }]
            ...
            fa.select('.nv-context').attr('transform', 'translate(0,' + (Y + w.bottom + x.top) + ')'),
              ka.transition().call(m),
              la.transition().call(k),
              G &&
                (o._ticks(a.utils.calcTicksX(X / 100, v)).tickSize(-Z, 0),
                fa.select('.nv-context .nv-x.nv-axis').attr('transform', 'translate(0,' + h.range()[0] + ')'),
            ...
            na.append('rect').attr('class', 'left').attr('x', 0).attr('y', 0).attr('height', Z),
              na.append('rect').attr('class', 'right').attr('x', 0).attr('y', 0).attr('height', Z);
          ...
          {},
          {
            ...
            switchYAxisOrder: {
              ...
              set: function (a) {
                ...
                (Q = a), p.orient('left'), q.orient('right'), r.orient('left'), s.orient('right');
              },
            },
          }
        )),
      ...
      function b(F) {
        return (
          ...
          F.each(function (b) {
            ...
            var Q = D.transition(P.exit().selectAll('rect.nv-bar'), 'multibarExit', Math.min(100, z))
            ...
            R.style('fill', function (a, b, c) {
              ...
              .on('mouseover', function (a, b) {
                d3.select(this).classed('hover', !0),
                  C.elementMouseover({ data: a, index: b, color: d3.select(this).style('fill') });
              })
              .on('mouseout', function (a, b) {
                d3.select(this).classed('hover', !1),
              ...
              .on('dblclick', function (a, b) {
                C.elementDblClick({ data: a, index: b, color: d3.select(this).style('fill') }),
                  d3.event.stopPropagation();
              }),
                  ...
                  .attr('x', function (a, c, d) {
                    ...
                    return (
                      b[d].nonStackable &&
                        ...
                        b.length !== H && (e = (b[d].nonStackableSeries * m.rangeBand()) / (2 * H))),
                      e
                    );
                  })
                  .attr('width', function (a, c, d) {
        ...
        return (
          ...
          B.each(function (B) {
            ...
            if (
              ...
              var M;
              A = {};
              for (M in z) z[M] instanceof Array ? (A[M] = z[M].slice(0)) : (A[M] = z[M]);
            }
            if (
              !(
                B &&
            ...
            var N = G.selectAll('g.nv-wrap.nv-multiBarWithLegend').data([B]),
              O = N.enter().append('g').attr('class', 'nvd3 nv-wrap nv-multiBarWithLegend').append('g'),
              P = N.select('g');
            if (
              ...
              r
                ? (i.width(K - D()),
                  ...
                  i.height() > l.top && ((l.top = i.height()), (L = a.utils.availableHeight(n, G, l))),
                  P.select('.nv-legendWrap').attr('transform', 'translate(' + D() + ',' + -l.top + ')'))
              ...
              j.width(D()).color(['#444', '#444', '#444']),
                P.select('.nv-controlsWrap')
                  ...
                  .call(j);
            } else P.select('.nv-controlsWrap').selectAll('*').remove();
            N.attr('transform', 'translate(' + l.left + ',' + l.top + ')'),
              u && P.select('.nv-y.nv-axis').attr('transform', 'translate(' + K + ',0)'),
              e
                .disabled(
                  B.map(function (a) {
                    return a.disabled;
            ...
            var R = P.select('.nv-barsWrap').datum(
              B.filter(function (a) {
                return !a.disabled;
              })
            );
            if ((R.call(e), s)) {
              f
                ...
                .tickSize(-L, 0),
                P.select('.nv-x.nv-axis').attr('transform', 'translate(0,' + d.range()[0] + ')'),
              ...
              x && P.selectAll('.tick text').call(a.utils.wrapTicks, b.xAxis.rangeBand()),
                v &&
                  S.filter(function (a, b) {
                    return b % Math.ceil(B[0].values.length / (K / 100)) !== 0;
                  })
                    .selectAll('text, line')
                    .style('opacity', 0),
                y &&
            ...
            t &&
              ...
              F &&
                (h.width(K).height(L).margin({ left: l.left, top: l.top }).svgContainer(G).xScale(c),
              ...
              C.on('changeState', function (a) {
                'undefined' != typeof a.disabled &&
                  ...
                  'undefined' != typeof a.stacked && (e.stacked(a.stacked), (z.stacked = a.stacked), (H = a.stacked)),
                  b.update();
              }),
              F
                    ...
                    if (void 0 != a.pointXValue) {
                      ...
                      B.filter(function (a, b) {
                        ...
                        void 0 !== k &&
                          ...
                          void 0 === d && (d = k),
                          void 0 === f && (f = a.mouseX),
                          i.push({ key: h.key, value: b.y()(k, e), color: o(h, h.seriesIndex), data: h.values[e] }));
                      }),
          ...
          G.renderEnd('multibarchart immediate'),
          b
        );
      }
      var c,
        ...
        return (
          ...
          m.each(function (b) {
            ...
            o
              ...
              x && !w
                ? p.range(g || [p.domain()[0] < 0 ? z : 0, m - (p.domain()[1] > 0 ? z : 0)])
                : p.range(g || [0, m]),
              (h = h || o),
              (i =
                i ||
            ...
            var M = L.enter()
              ...
              .attr('transform', function (a, c, d) {
                return (
                  'translate(' + i(w ? a.y0 : 0) + ',' + (w ? 0 : (d * o.rangeBand()) / b.length + o(q(a, c))) + ')'
                );
              });
            M.append('rect')
              .attr('width', 0)
              ...
              L.on('mouseover', function (a, b) {
                d3.select(this).classed('hover', !0),
                  E.elementMouseover({ data: a, index: b, color: d3.select(this).style('fill') });
              })
                .on('mouseout', function (a, b) {
                  d3.select(this).classed('hover', !1),
                ...
                .on('dblclick', function (a, b) {
                  E.elementDblClick({ data: a, index: b, color: d3.select(this).style('fill') }),
                    d3.event.stopPropagation();
                }),
              s(b[0], 0) &&
                (M.append('polyline'),
            ...
            if (
              ...
              q
                ? (h.width(C - y()),
                  ...
                  h.height() > k.top && ((k.top = h.height()), (D = a.utils.availableHeight(m, w, k))),
              ...
              i.width(y()).color(['#444', '#444', '#444']),
                H.select('.nv-controlsWrap')
                  ...
                  .call(i);
            } else H.select('.nv-controlsWrap').selectAll('*').remove();
      ...
      function b(j) {
        return (
          j.each(function (j) {
            ...
            function J(a) {
              var b = 2 === j[a.seriesIndex].yAxis ? E : D;
              (a.point.x = A.x()(a.point)),
                (a.point.y = A.y()(a.point)),
                G.duration(0)
                  .headerFormatter(function (a, b) {
                    return C.tickFormat()(a, b);
                  })
            ...
            r.domain(
              d3.extent(d3.merge(Y.concat(Z)), function (a) {
                return a.x;
              })
            ).range([0, O]);
                ...
                aa
                  ...
                  .datum(
                    j.map(function (a) {
                      return (
                        (a.originalKey = void 0 === a.originalKey ? a.key : a.originalKey),
                        (a.key = a.originalKey + (1 == a.yAxis ? '' : q)),
                        a
                      );
                    })
                  )
                  .call(F),
                F.height() > e.top && ((e.top = F.height()), (P = a.utils.availableHeight(h, N, e))),
                aa.select('.legendWrap').attr('transform', 'translate(' + da + ',' + -e.top + ')');
            } else aa.select('.legendWrap').selectAll('*').remove();
            u
              .width(O)
              .height(P)
              .interpolate(m)
            ...
            var ea = aa.select('.lines1Wrap').datum(
                Q.filter(function (a) {
                  return !a.disabled;
                })
              ),
              fa = aa.select('.scatters1Wrap').datum(
                S.filter(function (a) {
                  return !a.disabled;
                })
              ),
              ga = aa.select('.bars1Wrap').datum(
                U.filter(function (a) {
                  return !a.disabled;
                })
              ),
              ha = aa.select('.stack1Wrap').datum(
                W.filter(function (a) {
                  return !a.disabled;
                })
              ),
              ia = aa.select('.lines2Wrap').datum(
                R.filter(function (a) {
                  return !a.disabled;
                })
              ),
              ja = aa.select('.scatters2Wrap').datum(
                T.filter(function (a) {
                  return !a.disabled;
                })
              ),
              ka = aa.select('.bars2Wrap').datum(
                V.filter(function (a) {
                  return !a.disabled;
                })
              ),
              la = aa.select('.stack2Wrap').datum(
                X.filter(function (a) {
                  return !a.disabled;
                })
              ),
            ...
            s
              .domain(
                c ||
                  d3.extent(d3.merge(Y).concat(ma), function (a) {
                    return a.y;
                  })
              )
              .range([0, P]),
              ...
              aa.select('.nv-x.nv-axis').attr('transform', 'translate(0,' + P + ')'),
              ...
              p &&
                (o.width(O).height(P).margin({ left: e.left, top: e.top }).svgContainer(N).xScale(r),
                $.select('.nv-interactive').call(o)),
              p
                ? (o.dispatch.on('elementMousemove', function (c) {
                    L();
                    var d,
                      e,
                      g,
        ...
        return (
          y.each(function (b) {
            ...
            l.domain(c || d3.extent(b[0].values.map(n).concat(t))),
              ...
              m
                .domain(d || [d3.min(b[0].values.map(s).concat(u)), d3.max(b[0].values.map(r).concat(u))])
                .range(f || [A, 0]),
              l.domain()[0] === l.domain()[1] &&
                (l.domain()[0]
                  ? l.domain([l.domain()[0] - 0.01 * l.domain()[0], l.domain()[1] + 0.01 * l.domain()[1]])
          ...
          B.each(function (b) {
              ...
              return x(
                o.map(function (b) {
                  ...
                  return (
                    void 0 !== U &&
                      (v.length > 0 || O
                        ? (U.style('display', 'inline'), V.style('display', 'inline'))
            ...
            function B(a) {
              s.forEach(function (b) {
                ...
                b.hasOnlyNaN &&
                  (b.extent[1] =
                    ((l[b.dimension].domain()[1] - c[0]) * (b.extent[1] - b.extent[0])) /
                ...
                c.style('display', function (a) {
                  var b = $.every(function (b, c) {
                    return (isNaN(a.values[b]) || isNaN(parseFloat(a.values[b]))) &&
                      ...
                      ? !0
                      : _[c][0] <= a.values[b] && a.values[b] <= _[c][1] && !isNaN(parseFloat(a.values[b]));
                  });
              ...
              e.select('.nv-axis').each(function (a, b) {
                ...
                (P[a.key] = l[a.key].domain()),
                  0 != c.length &&
                    q &&
                    ((P[a.key] = []),
                    c[0].extent[1] > l[a.key].domain()[0] && (P[a.key] = [c[0].extent[1]]),
                    c[0].extent[0] >= l[a.key].domain()[0] && P[a.key].push(c[0].extent[0])),
                  d3.select(this).call(y.scale(l[a.key]).tickFormat(a.format).tickValues(P[a.key]));
              });
            }
            function G(a) {
            ...
            function H(a) {
              (u[a.key] = Math.min(i, Math.max(0, (this.parentNode.__origin__ += d3.event.x)))),
                c.attr('d', A),
                o.sort(function (a, b) {
            ...
            function I(a, b) {
              delete this.parentNode.__origin__,
                delete u[a.key],
                d3.select(this.parentNode).attr('transform', 'translate(' + k(a.key) + ')'),
                c.attr('d', A),
            ...
            p.forEach(function (a) {
              ...
              0 !== f.length &&
                (e
                  ...
                  : !f[0].hasOnlyNaN && q
                  ? ((c = c > f[0].extent[0] ? f[0].extent[0] : c), (d = d < f[0].extent[1] ? f[0].extent[1] : d))
                  : f[0].hasNaN &&
                    ((d = d < f[0].extent[1] ? f[0].extent[1] : d), (N[a] = l[a].domain()[1]), (O = !0))),
                (l[a] = d3.scale
                  .linear()
                  .domain([c, d])
                  .range([0.9 * (j - 12), 0])),
                (v = []),
                (l[a].brush = d3.svg.brush().y(l[a]).on('brushstart', C).on('brush', D).on('brushend', E));
            });
            ...
            S.append('g').attr('class', 'nv-parallelCoordinates background'),
              ...
              S.append('g').attr('class', 'nv-parallelCoordinates missingValuesline'),
            ...
            (d = Q.select('.background').selectAll('path').data(b)),
              ...
              c.on('mouseover', function (a, b) {
                d3
                  ...
                  .style('stroke-opacity', 1),
                  z.elementMouseover({ label: a.name, color: a.color || r(a, b), values: a.values, dimensions: o });
              }),
            ...
            (t = []),
              c.style('display', function (a) {
                var b = $.every(function (b, c) {
                  return (isNaN(a.values[b]) || isNaN(parseFloat(a.values[b]))) && _[c][0] == l[b].brush.y().domain()[0]
                    ? !0
                    : _[c][0] <= a.values[b] && a.values[b] <= _[c][1] && !isNaN(parseFloat(a.values[b]));
                });
                return b && t.push(a), b ? null : 'none';
        ...
        return (
          ...
          e.each(function (e) {
            ...
            if (
              ...
              l.forEach(function (a, b) {
                (a.originalPosition = isNaN(a.originalPosition) ? b : a.originalPosition),
                  (a.currentPosition = isNaN(a.currentPosition) ? b : a.currentPosition);
              }),
              !n)
            ) {
              var r;
              n = {};
              for (r in k) k[r] instanceof Array ? (n[r] = k[r].slice(0)) : (n[r] = k[r]);
            }
            if (!e || !e.length) return a.utils.noData(b, j), b;
            j.selectAll('.nv-noData').remove();
            var u = j.selectAll('g.nv-wrap.nv-parallelCoordinatesChart').data([e]),
              v = u.enter().append('g').attr('class', 'nvd3 nv-wrap nv-parallelCoordinatesChart').append('g'),
              w = u.select('g');
              ...
              i
                ? (d.width(o).color(function (a) {
                  ...
                  w
                    ...
                    .call(d),
                  d.height() > f.top && ((f.top = d.height()), (p = a.utils.availableHeight(h, j, f))),
                  u.select('.nv-legendWrap').attr('transform', 'translate( 0 ,' + -f.top + ')'))
          ...
          r.renderEnd('parraleleCoordinateChart immediate'),
          b
        );
      }
        ...
        c.dispatch.on('elementMouseover.tooltip', function (a) {
          ...
          a.values &&
            (Object.keys(a.values).forEach(function (c) {
              ...
              if (d) {
                var e;
                (e = isNaN(a.values[c]) || isNaN(parseFloat(a.values[c])) ? p : d.format(a.values[c])),
                  b.series.push({ idx: d.currentPosition, key: c, value: e, color: d.color });
              }
            }),
          ...
          F.each(function (b) {
            ...
            V.padAngle && v && V.padAngle(v),
              p &&
                ...
                O.select('.nv-pie-title')
                  ...
                  .style('font-size', (Math.min(G, H) * y * 2) / (q.length + 2) + 'px')
                  .attr('dy', '0.35em')
                  .attr('transform', function (a, b) {
            ...
            Y.attr('class', 'nv-slice'),
              ...
              Y.on('mouseout', function (a, b) {
                d3.select(this).classed('hover', !1),
                  r && d3.select(this).select('path').transition().duration(50).attr('d', C[b]),
            ...
            if (
              ...
              for (var Z = [], N = 0; N < b[0].length; N++)
                Z.push(C[N]),
                  m
                    ? p &&
                      ((Z[N] = d3.svg.arc().outerRadius(C[N].outerRadius())),
                  ...
                  c.attr('transform', function (a, b) {
                    if (t) {
                      ...
                      return (
                        ...
                        'translate(' + Z[b].centroid(a) + ') rotate(' + c + ')'
                      );
                    }
    ...
    (a.models.pieChart = function () {
        ...
        return (
          ...
          e.each(function (e) {
            ...
            if (
              ...
              (b.container = this),
              m.setter(t(e), b.update).getter(s(e)).update(),
              (m.disabled = e.map(function (a) {
                return !!a.disabled;
              })),
              !n)
            ) {
              var p;
              n = {};
              for (p in m) m[p] instanceof Array ? (n[p] = m[p].slice(0)) : (n[p] = m[p]);
            }
            if (!e || !e.length) return a.utils.noData(b, i), b;
            i.selectAll('.nv-noData').remove();
            var r = i.selectAll('g.nv-wrap.nv-pieChart').data([e]),
              u = r.enter().append('g').attr('class', 'nvd3 nv-wrap nv-pieChart').append('g'),
              v = r.select('g');
            if ((u.append('g').attr('class', 'nv-pieWrap'), u.append('g').attr('class', 'nv-legendWrap'), j)) {
              if ('top' === k)
                d.width(l).key(c.x()),
                  r.select('.nv-legendWrap').datum(e).call(d),
                  d.height() > f.top && ((f.top = d.height()), (o = a.utils.availableHeight(h, i, f))),
            ...
            } else v.select('.nv-legendWrap').selectAll('*').remove();
            r.attr('transform', 'translate(' + f.left + ',' + f.top + ')'), c.width(l).height(o);
          ...
          r.renderEnd('pieChart immediate'),
          b
        );
      }
      var c = a.models.pie(),
      ...
      return (
        c.dispatch.on('elementMouseover.tooltip', function (a) {
          (a.series = { key: b.x()(a.data), value: b.y()(a.data), color: a.color, percent: a.percent }),
    ...
    (a.models.scatter = function () {
      ...
      function b(a) {
        var b, c;
        return (b = i = i || {}), (c = a[0].series), (b = b[c] = b[c] || {}), (c = a[1]), (b = b[c] = b[c] || {});
      }
      function c(a) {
        var c,
          d,
        ...
        for (c = 1; c < arguments.length; c++)
          (d = arguments[c]), (f[d] === e[d] && f.hasOwnProperty(d)) || ((f[d] = e[d]), (g = !0));
        return g;
      }
      function d(b) {
        return (
          ...
          b.each(function (b) {
              ...
              if (P === !0) {
                    ...
                    return b.values
                      .map(function (b, d) {
                        ...
                        return [
                          ...
                          a.utils.NaNtoZero(q(f)) + 1e-4 * Math.random(),
                          c,
                          d,
                          b,
                        ];
                ...
                f.on('click', function (a) {
                  ...
                  .on('dblclick', function (a) {
                    i(a, O.elementDblClick);
                  })
                  .on('mouseover', function (a) {
                    i(a, O.elementMouseover);
                  })
                  .on('mouseout', function (a, b) {
                    i(a, O.elementMouseout);
                  });
              } else
                _.select('.nv-groups')
                  .selectAll('.nv-group')
            ...
            if (
              ...
              B && b[0]
                ? p.range(J || [(Q * C + Q) / (2 * b[0].values.length), Q - (Q * (1 + C)) / (2 * b[0].values.length)])
                : p.range(J || [0, Q]),
              X)
            ) {
              var Z = d3.min(
            ...
            r
              ...
              .range(M || V),
              (N = p.domain()[0] === p.domain()[1] || q.domain()[0] === q.domain()[1]),
              p.domain()[0] === p.domain()[1] &&
                (p.domain()[0]
                  ? p.domain([p.domain()[0] - 0.01 * p.domain()[0], p.domain()[1] + 0.01 * p.domain()[1]])
                  : p.domain([-1, 1])),
              q.domain()[0] === q.domain()[1] &&
                (q.domain()[0]
                  ? q.domain([q.domain()[0] - 0.01 * q.domain()[0], q.domain()[1] + 0.01 * q.domain()[1]])
                  : q.domain([-1, 1])),
              isNaN(p.domain()[0]) && p.domain([-1, 1]),
              isNaN(q.domain()[0]) && q.domain([-1, 1]),
              (e = e || p),
              (f = f || q),
              (g = g || r);
            var $ = p(1) !== e(1) || q(1) !== f(1) || r(1) !== g(1),
              ...
              aa = _.enter()
                .append('g')
                .attr('class', 'nvd3 nv-wrap nv-scatter nv-chart-' + n),
              ba = aa.append('defs'),
              ca = aa.append('g'),
              da = _.select('g');
            ...
            ea.enter().append('g').style('stroke-opacity', 1e-6).style('fill-opacity', 1e-6),
              ea.exit().remove(),
              ea
                .attr('class', function (a, b) {
                  return (a.classed || '') + ' nv-group nv-series-' + b;
              ...
              ea
                .watchTransition(U, 'scatter: groups')
                .style('fill', function (a, b) {
                  return m(a, b);
                })
                .style('stroke', function (a, b) {
            ...
            if (
              (fa
                ...
                .attr('transform', function (b) {
                  return (
                    'translate(' + a.utils.NaNtoZero(e(s(b[0], b[1]))) + ',' + a.utils.NaNtoZero(f(t(b[0], b[1]))) + ')'
                  );
                })
                .attr(
                  'd',
              ...
              ea
                ...
                .attr('transform', function (b) {
                  return (
                    'translate(' + a.utils.NaNtoZero(p(s(b[0], b[1]))) + ',' + a.utils.NaNtoZero(q(t(b[0], b[1]))) + ')'
                  );
                })
                .remove(),
              fa
              ...
              ga
                ...
                .attr('transform', function (b) {
                  var c = a.utils.NaNtoZero(e(s(b[0], b[1]))) + Math.sqrt(r(u(b[0], b[1])) / Math.PI) + 2;
                  return 'translate(' + c + ',' + a.utils.NaNtoZero(f(t(b[0], b[1]))) + ')';
                })
                .text(function (a, b) {
                  return a[0].label;
                }),
                ...
                ea
                  ...
                  .watchTransition(U, 'scatter exit')
                  .attr('transform', function (b) {
                    var c = a.utils.NaNtoZero(p(s(b[0], b[1]))) + Math.sqrt(r(u(b[0], b[1])) / Math.PI) + 2;
                    return 'translate(' + c + ',' + a.utils.NaNtoZero(q(t(b[0], b[1]))) + ')';
                  })
                  .remove(),
                ga.each(function (a) {
                  d3.select(this)
                ...
                ga.watchTransition(U, 'scatter labels').attr('transform', function (b) {
                  var c = a.utils.NaNtoZero(p(s(b[0], b[1]))) + Math.sqrt(r(u(b[0], b[1])) / Math.PI) + 2;
                  return 'translate(' + c + ',' + a.utils.NaNtoZero(q(t(b[0], b[1]))) + ')';
                });
            }
            R ? (clearTimeout(h), (h = setTimeout(i, R))) : i(), (e = p.copy()), (f = q.copy()), (g = r.copy());
          }),
          U.renderEnd('scatter immediate'),
          d
        );
      }
      var e,
        ...
        M = null,
        N = !1,
        O = d3.dispatch('elementClick', 'elementDblClick', 'elementMouseover', 'elementMouseout', 'renderEnd'),
        P = !0,
        Q = 250,
        R = 300,
        S = !1,
        T = !1,
        U = a.utils.renderWatch(O, Q),
        V = [16, 256];
      return (
        (d.dispatch = O),
        (d.options = a.utils.optionsFunc.bind(d)),
        (d._calls = new (function () {
        ...
        O.on('elementMouseover.point', function (a) {
          z && d._calls.highlightPoint(a.seriesIndex, a.pointIndex, !0);
        }),
        O.on('elementMouseout.point', function (a) {
        ...
        return (
          ...
          z.each(function (z) {
            ...
            if (
              ...
              var J;
              x = {};
              for (J in w) w[J] instanceof Array ? (x[J] = w[J].slice(0)) : (x[J] = w[J]);
            }
            if (
              !(
                z &&
              ...
              return a.utils.noData(b, m), E.renderEnd('scatter immediate'), b;
            ...
            var K = m.selectAll('g.nv-wrap.nv-scatterChart').data([z]),
              ...
              N = K.select('g');
            if (
              (M.append('rect').attr('class', 'nvd3 nv-background').style('pointer-events', 'none'),
              M.append('g').attr('class', 'nv-x nv-axis'),
              M.append('g').attr('class', 'nv-y nv-axis'),
              ...
              v && N.select('.nv-y.nv-axis').attr('transform', 'translate(' + H + ',0)'),
              s)
            ) {
              var O = H;
              f.width(O),
                K.select('.nv-legendWrap').datum(z).call(f),
                f.height() > j.top && ((j.top = f.height()), (I = a.utils.availableHeight(l, m, j))),
                K.select('.nv-legendWrap').attr('transform', 'translate(0,' + -j.top + ')');
            } else N.select('.nv-legendWrap').selectAll('*').remove();
            K.attr('transform', 'translate(' + j.left + ',' + j.top + ')'),
              c
                .width(H)
                .height(I)
              ...
              K.select('.nv-scatterWrap')
                ...
                .call(c),
              K.select('.nv-regressionLinesWrap').attr('clip-path', 'url(#nv-edge-clip-' + c.id() + ')');
            ...
            var Q = P.selectAll('.nv-regLine').data(function (a) {
              return [a];
            });
            Q.enter().append('line').attr('class', 'nv-regLine').style('stroke-opacity', 0),
              Q.filter(function (a) {
              ...
              q &&
                ...
                M.select('.nv-distWrap').append('g').attr('class', 'nv-distributionX'),
              ...
              r &&
                ...
                M.select('.nv-distWrap').append('g').attr('class', 'nv-distributionY'),
                N.select('.nv-distributionY')
                  .attr('transform', 'translate(' + (v ? H : -h.size()) + ',0)')
                  .datum(
                    z.filter(function (a) {
                      return !a.disabled;
                    })
              ...
              c.dispatch.on('elementMouseover.tooltip', function (a) {
                m.select('.nv-series-' + a.seriesIndex + ' .nv-distx-' + a.pointIndex).attr('y1', a.relativePos[1] - I),
                  m
          ...
          E.renderEnd('scatter with line immediate'),
          b
        );
      }
      ...
      function b(k) {
        return (
          ...
          k.each(function (k) {
            function B() {
              s &&
                V.select('.nv-focus .nv-x.nv-axis')
            ...
            function J() {
              if (t) {
                ...
                } else H && (g.tickFormat(H), (H = null));
                V.select('.nv-focus .nv-y.nv-axis').transition().duration(0).call(g);
              }
            }
            function O(a) {
              var b = V.select('.nv-focus .nv-stackedWrap').datum(
                k
                  .filter(function (a) {
                    return !a.disabled;
                  })
            ...
            if (
              ((b.update = function () {
                P.transition().duration(G).call(b);
              }),
              (b.container = this),
              z.setter(M(k), b.update).getter(L(k)).update(),
              (z.disabled = k.map(function (a) {
                return !!a.disabled;
              })),
              !A)
            ) {
              var S;
              A = {};
              for (S in z) z[S] instanceof Array ? (A[S] = z[S].slice(0)) : (A[S] = z[S]);
            }
            if (
              !(
                k &&
            ...
            var T = P.selectAll('g.nv-wrap.nv-stackedAreaChart').data([k]),
              U = T.enter().append('g').attr('class', 'nvd3 nv-wrap nv-stackedAreaChart').append('g'),
              V = T.select('g');
            U.append('g').attr('class', 'nv-legendWrap'), U.append('g').attr('class', 'nv-controlsWrap');
            ...
            if (r) {
              var X = q ? Q - D : Q;
              h.width(X),
                V.select('.nv-legendWrap').datum(k).call(h),
                h.height() > m.top &&
                  ((m.top = h.height()), (R = a.utils.availableHeight(o, P, m) - (v ? l.height() : 0))),
                V.select('.nv-legendWrap').attr('transform', 'translate(' + (Q - X) + ',' + -m.top + ')');
            } else V.select('.nv-legendWrap').selectAll('*').remove();
            if (q) {
              var Y = [
                { key: F.stacked || 'Stacked', metaKey: 'Stacked', disabled: 'stack' != e.style(), style: 'stack' },
              ...
              (D = (E.length / 3) * 260),
                (Y = Y.filter(function (a) {
                  return -1 !== E.indexOf(a.metaKey);
                })),
                i.width(D).color(['#444', '#444', '#444']),
                V.select('.nv-controlsWrap').datum(Y).call(i),
                Math.max(i.height(), h.height()) > m.top &&
                  ((m.top = Math.max(i.height(), h.height())), (R = a.utils.availableHeight(o, P, m))),
                V.select('.nv-controlsWrap').attr('transform', 'translate(0,' + -m.top + ')');
            } else V.select('.nv-controlsWrap').selectAll('*').remove();
            T.attr('transform', 'translate(' + m.left + ',' + m.top + ')'),
              u && V.select('.nv-y.nv-axis').attr('transform', 'translate(' + Q + ',0)'),
              w &&
                (j.width(Q).height(R).margin({ left: m.left, top: m.top }).svgContainer(P).xScale(c),
                T.select('.nv-interactive').call(j)),
              V.select('.nv-focus .nv-background rect').attr('width', Q).attr('height', R),
              e
                .width(Q)
                .height(R)
                .color(
            ...
            var Z = V.select('.nv-focus .nv-stackedWrap').datum(
              k.filter(function (a) {
                return !a.disabled;
              })
            );
            if (
              ...
              var $;
              ($ = 'wiggle' === e.offset() ? 0 : a.utils.calcTicksY(R / 36, k)), g.scale(d)._ticks($).tickSize(-Q, 0);
            }
            if (v) {
              l.width(Q),
                V.select('.nv-focusWrap')
                  .attr('transform', 'translate(0,' + (R + m.bottom + l.margin().top) + ')')
                  .datum(
                    k.filter(function (a) {
                      return !a.disabled;
                    })
            ...
            e.dispatch.on('areaClick.toggle', function (a) {
              ...
              j.dispatch.on('elementMousemove', function (c) {
                  ...
                  (k
                    ...
                    .forEach(function (j, k) {
                      ...
                      if ((null != n && e.highlightPoint(k, f, !0), 'undefined' != typeof m)) {
                        ...
                        h.push({ key: j.key, value: o, color: p(j, j.seriesIndex), point: m }),
                          x && 'expand' != e.style() && null != o && ((i += o), (l = !1));
                      }
                    }),
                  h.reverse(),
                  h.length > 2)
                ...
                x && 'expand' != e.style() && h.length >= 2 && !l && h.push({ key: y, value: i, total: !0 });
                var o = b.x()(d, f),
                  q = j.tooltip.valueFormatter();
                'expand' === e.style() || 'stack_percent' === e.style()
                  ? (I || (I = q), (q = d3.format('.1%')))
                  : I && ((q = I), (I = null)),
                  j.tooltip.valueFormatter(q).data({ value: o, series: h })(),
                  j.renderGuideLine(g);
              }),
              j.dispatch.on('elementMouseout', function (a) {
                e.clearHighlights();
              ...
              C.on('changeState', function (a) {
                'undefined' != typeof a.disabled &&
                  ...
                  (z.disabled = a.disabled)),
                  'undefined' != typeof a.style && (e.style(a.style), (K = a.style)),
                  b.update();
              });
          }),
          J.renderEnd('stacked Area chart immediate'),
          b
        );
      }
      var c,
        ...
        m = { top: 30, right: 25, bottom: 50, left: 60 },
        n = null,
        o = null,
        ...
        (b._options = Object.create(
          {},
          {
            ...
            focusMargin: {
              ...
              set: function (a) {
                (l.margin.top = void 0 !== a.top ? a.top : l.margin.top),
                  ...
                  (l.margin.bottom = void 0 !== a.bottom ? a.bottom : l.margin.bottom),
            ...
            useInteractiveGuideline: {
              ...
              set: function (a) {
                (w = !!a), b.interactive(!a), b.useVoronoi(!a), e.scatter.interactive(!a);
              },
            },
          }
        )),
                ...
                g.transition()
                  ...
                  .attr('transform', function () {
                    ...
                    return 0 === g
                      ...
                      : 'rotate(' + f + ')translate(' + (G(d.y) + e + 5) + ',0)rotate(' + g + ')';
                  });
              }
            });
      }
      function k(f) {
        return (
          ...
          f.each(function (f) {
            ...
            h[0][0]
              ? h.attr('transform', 'translate(' + (m / 2 + p.left + p.right) + ',' + (n / 2 + p.top + p.bottom) + ')')
              : (h = v
                  .append('g')
                  .attr('class', 'nvd3 nv-wrap nv-sunburst nv-chart-' + u)
                  .attr(
                    'transform',
                    'translate(' + (m / 2 + p.left + p.right) + ',' + (n / 2 + p.top + p.bottom) + ')'
                  )),
            ...
            z
              ...
              .on('mouseover', function (a, b) {
                d3.select(this).classed('hover', !0).style('opacity', 0.8),
                  E.elementMouseover({ data: a, color: d3.select(this).style('fill'), percent: d(a) });
              })
              .on('mouseout', function (a, b) {
                ...
                l
                  ...
                  .attr('transform', function (a) {
                    ...
                    return 0 === f
                      ...
                      : 'rotate(' + e + ')translate(' + (G(a.y) + d + 5) + ',0)rotate(' + f + ')';
                  })),
              j(k[k.length - 1]),
              l
                .exit()
    ...
    (a.models.sunburstChart = function () {
        ...
        return (
          ...
          d.each(function (d) {
            ...
            return (
              ...
              (b.container = h),
              d && d.length
                ? (h.selectAll('.nv-noData').remove(), c.width(i).height(j).margin(e), void h.call(c))
      ...
      return (
        ...
        c.dispatch.on('elementMouseover.tooltip', function (a) {
          (a.series = { key: a.data.name, value: a.data.value || a.data.size, color: a.color, percent: a.percent }),
            i || (delete a.percent, delete a.series.percent),
            d.data(a).hidden(!1);
        }),
        c.dispatch.on('elementMouseout.tooltip', function (a) {
