!(function () {
        ...
        r && e
          ? function (n, t) {
              for (
                ...
                u > 0 &&
                a > 0 &&
                (c + a + 1 > t && (a = Math.max(1, t - c)), i.push(n.substring((u -= a), u + a)), !((c += a + 1) > t));
        ...
        if (((i = e - c), p || !(0 > i))) {
          ...
          if (((i = t - l), v || !(i > 0))) {
            ...
            if (((i = r - l), v || !(0 > i))) {
              ...
              return (
                h > 0 && (u.a = { x: c + h * p, y: l + h * v }), 1 > g && (u.b = { x: c + g * p, y: l + g * v }), u
              );
            }
          }
        }
  ...
  function Ir(n) {
    for (
      var t, e, r, u, i, o, a, c, l, s, f = n[0][0], h = n[1][0], g = n[0][1], p = n[1][1], v = Kc, d = v.length;
      d--;
  ...
  function no(n, t) {
    ...
    return (
      ...
      (o.invertExtent = function (e) {
        return (
          (e = t.indexOf(e)), 0 > e ? [0 / 0, 0 / 0] : [e > 0 ? a[e - 1] : n[0], e < a.length ? a[e] : n[n.length - 1]]
        );
      }),
      (o.copy = function () {
        return no(n, t);
  ...
  (ta.ns = {
    ...
    qualify: function (n) {
      var t = n.indexOf(':'),
        e = n;
      return (
        t >= 0 && ((e = n.slice(0, t)), (n = n.slice(t + 1))), wa.hasOwnProperty(e) ? { space: wa[e], local: n } : n
      );
    },
  }),
  ...
  (ta.geo.bounds = (function () {
    ...
    (ta.geo.centroid = function (n) {
      ...
      var t = Nc,
        ...
        u = t * t + e * e + r * r;
      return za > u &&
        ((t = kc), (e = Ec), (r = Ac), Ca > bc && ((t = _c), (e = wc), (r = Sc)), (u = t * t + e * e + r * r), za > u)
        ? [0 / 0, 0 / 0]
  ...
  (ta.geo.path = function () {
    ...
    return (
      ...
      (n.context = function (n) {
        return arguments.length
          ? ((i = null == (r = n) ? new $e() : new Qe(n)), 'function' != typeof a && i.pointRadius(a), t())
          : r;
      }),
    ...
    (ta.geo.graticule = function () {
      ...
      return (
        ...
        (n.precision = function (t) {
          return arguments.length
            ? ((y = +t), (s = vr(a, o, 90)), (f = dr(r, e, y)), (h = vr(l, c, 90)), (g = dr(i, u, y)), n)
            : y;
        }),
        n
          .majorExtent([
      ...
      remove: function (n) {
        ...
        if (
          ...
          do {
            ...
            if (n === u.L) {
              if (
                ((t = u.R), t.C && ((t.C = !1), (u.C = !0), eu(this, u), (t = u.R)), (t.L && t.L.C) || (t.R && t.R.C))
              ) {
              ...
              ((t = u.L), t.C && ((t.C = !1), (u.C = !0), ru(this, u), (t = u.L)), (t.L && t.L.C) || (t.R && t.R.C))
            ) {
    ...
    (ta.layout.force = function () {
      ...
      return (
        ...
        (a.alpha = function (n) {
          return arguments.length
            ? ((n = +n),
              r ? (r = n > 0 ? n : 0) : n > 0 && (c.start({ type: 'start', alpha: (r = n) }), ta.timer(a.tick)),
              a)
            : r;
        }),
        (a.start = function () {
        ...
        (a.drag = function () {
          return (
            e ||
              (e = ta.behavior.drag().origin(y).on('dragstart.force', Xu).on('drag.force', t).on('dragend.force', $u)),
  ...
  (ta.layout.histogram = function () {
    ...
    (ta.layout.tree = function () {
      ...
      function u(n, t, e) {
        if (t) {
          for (
            var r, u = n, i = n, o = t, c = u.parent.children[0], l = u.m, s = i.m, f = o.m, h = c.m;
            (o = Ei(o)), (u = ki(u)), o && u;
    ...
    (ta.layout.treemap = function () {
      ...
      return (
        ...
        (i.padding = function (n) {
          ...
          return (
            (f =
              null == (s = n) ? Ri : 'function' == (r = typeof n) ? t : 'number' === r ? ((n = [n, n, n, n]), e) : e),
            i
          );
        }),
        (i.round = function (n) {
    ...
    (Pl.transition = function () {
      for (var n, t, e, r, u = this.id, i = ++Ul, o = this.namespace, a = [], c = 0, l = this.length; l > c; c++) {
        ...
        for (var t = this[c], s = 0, f = t.length; f > s; s++)
          (e = t[s]) &&
            ((r = e[o][u]),
            $o(e, s, o, i, { time: r.time, ease: r.ease, delay: r.delay + r.duration, duration: r.duration })),
            n.push(e);
      }
      return Yo(a, o, i);
    }),
    ...
    function i() {
      ...
      function m(n, t, e) {
        ...
        return (
          ...
          C
            ? (u = (r += s) + d)
            : (M && (s = Math.max(c, Math.min(l, 2 * M[e] - r))), r > s ? ((u = r), (r = s)) : (u = s)),
