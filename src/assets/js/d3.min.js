!(function () {
  ...
  function z(n, t) {
    ...
    return (
      (n = ta.ns.qualify(n)), null == t ? (n.local ? r : e) : "function" == typeof t ? (n.local ? a : o) : n.local ? i : u
    );
  }
  function q(n) {
  ...
  function Pt(n) {
    ...
    return function (n) {
      ...
      "$" === c && ((v = u[0]), (d = u[1])),
        "r" != g || h || (g = "g"),
        null != h &&
          ("g" == g ? (h = Math.max(1, Math.min(21, h))) : ("e" == g || "f" == g) && (h = Math.max(0, Math.min(20, h)))),
        (g = oc.get(g) || Ut);
      var M = l && f;
      return function (n) {
        var e = d;
  ...
  function _o(n, t) {
    ...
    if (
      ...
      (a = t[1]),
        ...
        c++,
        (r +=
          "C" + (u[0] + o[0]) + "," + (u[1] + o[1]) + "," + (i[0] - a[0]) + "," + (i[1] - a[1]) + "," + i[0] + "," + i[1]);
  ...
  (ta.selection.enter = Z),
    ...
    (ta.select = function (t) {
      var e;
      return (
        "string" == typeof t ? ((e = [Ma(t, ua)]), (e.parentNode = ua.documentElement)) : ((e = [t]), (e.parentNode = n(t))),
        A([e])
      );
    }),
    (ta.selectAll = function (n) {
      var t;
      return (
        "string" == typeof n ? ((t = ra(xa(n, ua))), (t.parentNode = ua.documentElement)) : ((t = n), (t.parentNode = null)),
        A([t])
      );
    }),
    ...
    (ta.layout.treemap = function () {
      ...
      return (
        ...
        (i.padding = function (n) {
          ...
          var r;
          return (
            (f = null == (s = n) ? Ri : "function" == (r = typeof n) ? t : "number" === r ? ((n = [n, n, n, n]), e) : e), i
          );
        }),
        (i.round = function (n) {
