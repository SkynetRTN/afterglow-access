...
export class CreateJob implements Action {
  ...
  constructor(public payload: { job: Job, autoUpdateInterval?: number }) { }
}
...
export class CreateJobFail implements Action {
  ...
  constructor(public payload: { job: Job, error: any }) { }
}
...
export class UpdateJobResultSuccess implements Action {
  ...
  constructor(public payload: { job: Job, result: JobResult }) { }
}
