...
var WorkbenchFileStates = /** @class */ (function () {
    ...
    WorkbenchFileStates.getWorkbenchFileStateByFileId = function (state) {
        return function (id) {
    ...
    WorkbenchFileStates.prototype.updateNormalizer = function (_a, _b) {
        ...
        return dispatch(new workbench_file_states_actions_1.RenormalizeImageFile(fileId));
    };
    /*Sonification*/
    WorkbenchFileStates.prototype.loadDataFileHdrSuccess = function (_a, _b) {
        ...
        if (dataFile.type == data_file_type_1.DataFileType.IMAGE) {
            ...
            if (!sonifierState.regionHistoryInitialized) {
                dispatch(new workbench_file_states_actions_1.AddRegionToHistory(imageFile.id, {
                    x: 0,
                    y: 0,
    ...
    WorkbenchFileStates.prototype.regionHistoryChanged = function (_a, _b) {
        ...
        if (state.entities[fileId].sonifier.regionMode == sonifier_file_state_1.SonifierRegionMode.CUSTOM) {
            dispatch(new workbench_file_states_actions_1.SonificationRegionChanged(fileId));
        }
    };
    WorkbenchFileStates.prototype.sonificationRegionChanged = function (_a, _b) {
        ...
        if (sonifierState.regionMode == sonifier_file_state_1.SonifierRegionMode.CUSTOM &&
            ...
            dispatch(new workbench_file_states_actions_1.CenterRegionInViewport(fileId, region, transformationState.viewportSize));
        }
    };
    ...
    WorkbenchFileStates.prototype.centerRegionInViewport = function (_a, _b) {
        ...
        return dispatch([
            new workbench_file_states_actions_1.ResetImageTransform(fileId),
            new workbench_file_states_actions_1.SetViewportTransform(fileId, viewportTransform)
        ]);
    };
    WorkbenchFileStates.prototype.zoomTo = function (_a, _b) {
        ...
        return dispatch(new workbench_file_states_actions_1.ZoomBy(fileId, zoomByFactor, anchorPoint));
    };
    ...
    __decorate([
        store_1.Action(workbench_file_states_actions_1.InitializeImageFileState),
        immer_adapter_1.ImmutableContext()
    ...
    __decorate([
        store_1.Action(workbench_file_states_actions_1.RenormalizeImageFile),
        immer_adapter_1.ImmutableContext()
    ], WorkbenchFileStates.prototype, "renormalizeImageFile");
    __decorate([
        store_1.Action(workbench_file_states_actions_1.NormalizeImageTile),
        immer_adapter_1.ImmutableContext()
    ...
    __decorate([
        store_1.Action([workbench_file_states_actions_1.AddRegionToHistory, workbench_file_states_actions_1.UndoRegionSelection, workbench_file_states_actions_1.RedoRegionSelection]),
        immer_adapter_1.ImmutableContext()
    ], WorkbenchFileStates.prototype, "regionHistoryChanged");
    __decorate([
        store_1.Action(workbench_file_states_actions_1.SonificationRegionChanged),
        immer_adapter_1.ImmutableContext()
    ], WorkbenchFileStates.prototype, "sonificationRegionChanged");
    __decorate([
        store_1.Action(workbench_file_states_actions_1.UpdateSonifierFileState),
        immer_adapter_1.ImmutableContext()
    ], WorkbenchFileStates.prototype, "updateSonifierFileState");
    __decorate([
        store_1.Action(workbench_file_states_actions_1.AddRegionToHistory),
        immer_adapter_1.ImmutableContext()
    ], WorkbenchFileStates.prototype, "addRegionToHistory");
    __decorate([
        store_1.Action(workbench_file_states_actions_1.UndoRegionSelection),
        immer_adapter_1.ImmutableContext()
    ], WorkbenchFileStates.prototype, "undoRegionSelection");
    __decorate([
        store_1.Action(workbench_file_states_actions_1.RedoRegionSelection),
        immer_adapter_1.ImmutableContext()
    ], WorkbenchFileStates.prototype, "redoRegionSelection");
    __decorate([
        store_1.Action(workbench_file_states_actions_1.ClearRegionHistory),
        immer_adapter_1.ImmutableContext()
    ], WorkbenchFileStates.prototype, "clearRegionHistory");
    __decorate([
        store_1.Action(workbench_file_states_actions_1.SetProgressLine),
        immer_adapter_1.ImmutableContext()
    ], WorkbenchFileStates.prototype, "setProgressLine");
    __decorate([
        store_1.Action(workbench_file_states_actions_1.UpdatePhotometryFileState),
        immer_adapter_1.ImmutableContext()
    ], WorkbenchFileStates.prototype, "updatePhotometryFileState");
    __decorate([
        store_1.Action(workbench_file_states_actions_1.CenterRegionInViewport),
        immer_adapter_1.ImmutableContext()
    ], WorkbenchFileStates.prototype, "centerRegionInViewport");
    __decorate([
        store_1.Action(workbench_file_states_actions_1.ZoomTo),
        immer_adapter_1.ImmutableContext()
    ], WorkbenchFileStates.prototype, "zoomTo");
    __decorate([
        store_1.Action(workbench_file_states_actions_1.ZoomBy),
        immer_adapter_1.ImmutableContext()
    ...
    __decorate([
        store_1.Action(workbench_file_states_actions_1.SetViewportTransform),
        immer_adapter_1.ImmutableContext()
    ], WorkbenchFileStates.prototype, "setViewportTransform");
    __decorate([
        store_1.Action(workbench_file_states_actions_1.SetImageTransform),
        immer_adapter_1.ImmutableContext()
    ], WorkbenchFileStates.prototype, "setImageTransform");
    __decorate([
        store_1.Action(workbench_file_states_actions_1.ResetImageTransform),
        immer_adapter_1.ImmutableContext()
    ], WorkbenchFileStates.prototype, "resetImageTransform");
    __decorate([
        store_1.Action(workbench_file_states_actions_1.RotateBy),
        immer_adapter_1.ImmutableContext()
    ], WorkbenchFileStates.prototype, "rotateBy");
    __decorate([
        store_1.Action(workbench_file_states_actions_1.Flip),
        immer_adapter_1.ImmutableContext()
    ], WorkbenchFileStates.prototype, "flip");
    __decorate([
        store_1.Action(workbench_file_states_actions_1.UpdateCurrentViewportSize),
        immer_adapter_1.ImmutableContext()
    ], WorkbenchFileStates.prototype, "updateCurrentViewportSize");
    __decorate([
        store_1.Action(workbench_file_states_actions_1.StartLine),
        immer_adapter_1.ImmutableContext()
    ], WorkbenchFileStates.prototype, "startLine");
    __decorate([
        store_1.Action(workbench_file_states_actions_1.UpdateLine),
        immer_adapter_1.ImmutableContext()
    ], WorkbenchFileStates.prototype, "updateLine");
    __decorate([
        store_1.Action(workbench_file_states_actions_1.UpdatePlotterFileState),
        immer_adapter_1.ImmutableContext()
    ], WorkbenchFileStates.prototype, "updatePlotterFileState");
    __decorate([
        store_1.Action(workbench_file_states_actions_1.UpdateCustomMarker),
        immer_adapter_1.ImmutableContext()
    ], WorkbenchFileStates.prototype, "updateCustomMarker");
    __decorate([
        store_1.Action(workbench_file_states_actions_1.AddCustomMarkers),
        immer_adapter_1.ImmutableContext()
    ], WorkbenchFileStates.prototype, "addCustomMarkers");
    __decorate([
        store_1.Action(workbench_file_states_actions_1.RemoveCustomMarkers),
        immer_adapter_1.ImmutableContext()
    ], WorkbenchFileStates.prototype, "removeCustomMarkers");
    __decorate([
        store_1.Action(workbench_file_states_actions_1.SelectCustomMarkers),
        immer_adapter_1.ImmutableContext()
    ], WorkbenchFileStates.prototype, "selectCustomMarkers");
    __decorate([
        store_1.Action(workbench_file_states_actions_1.DeselectCustomMarkers),
        immer_adapter_1.ImmutableContext()
    ], WorkbenchFileStates.prototype, "deselectCustomMarkers");
    __decorate([
        store_1.Action(workbench_file_states_actions_1.SetCustomMarkerSelection),
        immer_adapter_1.ImmutableContext()
    ...
    __decorate([
        store_1.Selector()
    ], WorkbenchFileStates, "getWorkbenchFileStateByFileId");
