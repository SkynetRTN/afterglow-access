...
exports.ImageFilesState = void 0;
...
var ImageFilesState = /** @class */ (function () {
    function ImageFilesState(store, afterglowDataFileService, correlationIdGenerator, actions$) {
        this.store = store;
        this.afterglowDataFileService = afterglowDataFileService;
        this.correlationIdGenerator = correlationIdGenerator;
        this.actions$ = actions$;
    }
    ImageFilesState.getState = function (state) {
        return state;
    };
    ImageFilesState.getEntities = function (state) {
        return state.entities;
    };
    ImageFilesState.getIds = function (state) {
        return state.ids;
    };
    ImageFilesState.getImageFileStates = function (state) {
        return Object.values(state.entities);
    };
    ImageFilesState.getImageFileStateByFileId = function (state) {
        return function (id) {
            return state.entities[id];
        };
    };
    ImageFilesState.prototype.resetState = function (_a, _b) {
        var getState = _a.getState, setState = _a.setState, dispatch = _a.dispatch;
        setState(function (state) {
            return defaultWorkbenchFileStatesModel;
        });
    };
    ImageFilesState.prototype.initializeImageFileState = function (_a, _b) {
        var getState = _a.getState, setState = _a.setState, dispatch = _a.dispatch;
    ...
    ImageFilesState.prototype.removeDataFileSuccess = function (_a, _b) {
        var getState = _a.getState, setState = _a.setState, dispatch = _a.dispatch;
    ...
    ImageFilesState.prototype.initImageTiles = function (_a, _b) {
        var _this = this;
        var getState = _a.getState, setState = _a.setState, dispatch = _a.dispatch;
        var fileId = _b.fileId;
        setState(function (state) {
    ...
    ImageFilesState.prototype.renormalizeImageFile = function (_a, _b) {
        var getState = _a.getState, setState = _a.setState, dispatch = _a.dispatch;
        var fileId = _b.fileId;
        setState(function (state) {
            var normalization = state.entities[fileId].normalization;
    ...
    ImageFilesState.prototype.normalizeImageTile = function (_a, _b) {
        var _this = this;
        var getState = _a.getState, setState = _a.setState, dispatch = _a.dispatch;
    ...
    ImageFilesState.prototype.updateNormalizer = function (_a, _b) {
        var getState = _a.getState, setState = _a.setState, dispatch = _a.dispatch;
    ...
    /*Sonification*/
    ImageFilesState.prototype.loadDataFileHdrSuccess = function (_a, _b) {
        var getState = _a.getState, setState = _a.setState, dispatch = _a.dispatch;
    ...
    ImageFilesState.prototype.regionHistoryChanged = function (_a, _b) {
        var getState = _a.getState, setState = _a.setState, dispatch = _a.dispatch;
        var fileId = _b.fileId;
        var state = getState();
    ...
    ImageFilesState.prototype.sonificationRegionChanged = function (_a, _b) {
        var getState = _a.getState, setState = _a.setState, dispatch = _a.dispatch;
        var fileId = _b.fileId;
        var dataFiles = this.store.selectSnapshot(data_files_state_1.DataFilesState.getEntities);
        var imageFile = dataFiles[fileId];
    ...
    ImageFilesState.prototype.updateSonifierFileState = function (_a, _b) {
        var _this = this;
        var getState = _a.getState, setState = _a.setState, dispatch = _a.dispatch;
        var fileId = _b.fileId, changes = _b.changes;
        setState(function (state) {
    ...
    ImageFilesState.prototype.addRegionToHistory = function (_a, _b) {
        var _this = this;
        var getState = _a.getState, setState = _a.setState, dispatch = _a.dispatch;
    ...
    ImageFilesState.prototype.undoRegionSelection = function (_a, _b) {
        var _this = this;
        var getState = _a.getState, setState = _a.setState, dispatch = _a.dispatch;
        var fileId = _b.fileId;
        setState(function (state) {
    ...
    ImageFilesState.prototype.redoRegionSelection = function (_a, _b) {
        var _this = this;
        var getState = _a.getState, setState = _a.setState, dispatch = _a.dispatch;
        var fileId = _b.fileId;
        setState(function (state) {
    ...
    ImageFilesState.prototype.clearRegionHistory = function (_a, _b) {
        var _this = this;
        var getState = _a.getState, setState = _a.setState, dispatch = _a.dispatch;
        var fileId = _b.fileId;
        setState(function (state) {
    ...
    ImageFilesState.prototype.setProgressLine = function (_a, _b) {
        var getState = _a.getState, setState = _a.setState, dispatch = _a.dispatch;
    ...
    ImageFilesState.prototype.updatePhotometryFileState = function (_a, _b) {
        var getState = _a.getState, setState = _a.setState, dispatch = _a.dispatch;
        var fileId = _b.fileId, changes = _b.changes;
        setState(function (state) {
    ...
    // }
    /* Transformation */
    ImageFilesState.prototype.centerRegionInViewport = function (_a, _b) {
        var getState = _a.getState, setState = _a.setState, dispatch = _a.dispatch;
    ...
    ImageFilesState.prototype.zoomTo = function (_a, _b) {
        var getState = _a.getState, setState = _a.setState, dispatch = _a.dispatch;
    ...
    ImageFilesState.prototype.zoomBy = function (_a, _b) {
        var _this = this;
        var getState = _a.getState, setState = _a.setState, dispatch = _a.dispatch;
    ...
    ImageFilesState.prototype.moveBy = function (_a, _b) {
        var _this = this;
        var getState = _a.getState, setState = _a.setState, dispatch = _a.dispatch;
    ...
    ImageFilesState.prototype.setViewportTransform = function (_a, _b) {
        var _this = this;
        var getState = _a.getState, setState = _a.setState, dispatch = _a.dispatch;
    ...
    ImageFilesState.prototype.setImageTransform = function (_a, _b) {
        var _this = this;
        var getState = _a.getState, setState = _a.setState, dispatch = _a.dispatch;
        var fileId = _b.fileId, transform = _b.transform;
        setState(function (state) {
    ...
    ImageFilesState.prototype.resetImageTransform = function (_a, _b) {
        var _this = this;
        var getState = _a.getState, setState = _a.setState, dispatch = _a.dispatch;
        var fileId = _b.fileId;
        setState(function (state) {
    ...
    ImageFilesState.prototype.rotateBy = function (_a, _b) {
        var _this = this;
        var getState = _a.getState, setState = _a.setState, dispatch = _a.dispatch;
    ...
    ImageFilesState.prototype.flip = function (_a, _b) {
        var _this = this;
        var getState = _a.getState, setState = _a.setState, dispatch = _a.dispatch;
        var fileId = _b.fileId;
        setState(function (state) {
    ...
    ImageFilesState.prototype.updateCurrentViewportSize = function (_a, _b) {
        var _this = this;
        var getState = _a.getState, setState = _a.setState, dispatch = _a.dispatch;
    ...
    ImageFilesState.prototype.startLine = function (_a, _b) {
        var _this = this;
        var getState = _a.getState, setState = _a.setState, dispatch = _a.dispatch;
    ...
    ImageFilesState.prototype.updateLine = function (_a, _b) {
        var _this = this;
        var getState = _a.getState, setState = _a.setState, dispatch = _a.dispatch;
        var fileId = _b.fileId, point = _b.point;
        setState(function (state) {
    ...
    ImageFilesState.prototype.updatePlotterFileState = function (_a, _b) {
        var _this = this;
        var getState = _a.getState, setState = _a.setState, dispatch = _a.dispatch;
        var fileId = _b.fileId, changes = _b.changes;
        setState(function (state) {
    ...
    //   }
    /*  Custom Markers */
    ImageFilesState.prototype.updateCustomMarker = function (_a, _b) {
        var getState = _a.getState, setState = _a.setState, dispatch = _a.dispatch;
    ...
    ImageFilesState.prototype.addCustomMarkers = function (_a, _b) {
        var getState = _a.getState, setState = _a.setState, dispatch = _a.dispatch;
    ...
    ImageFilesState.prototype.removeCustomMarkers = function (_a, _b) {
        var getState = _a.getState, setState = _a.setState, dispatch = _a.dispatch;
        var fileId = _b.fileId, markers = _b.markers;
        var state = getState();
        setState(function (state) {
    ...
    ImageFilesState.prototype.selectCustomMarkers = function (_a, _b) {
        var getState = _a.getState, setState = _a.setState, dispatch = _a.dispatch;
        var fileId = _b.fileId, markers = _b.markers;
        var state = getState();
        setState(function (state) {
    ...
    ImageFilesState.prototype.deselectCustomMarkers = function (_a, _b) {
        var getState = _a.getState, setState = _a.setState, dispatch = _a.dispatch;
        var fileId = _b.fileId, markers = _b.markers;
        var state = getState();
        setState(function (state) {
    ...
    ImageFilesState.prototype.setCustomMarkerSelection = function (_a, _b) {
        var getState = _a.getState, setState = _a.setState, dispatch = _a.dispatch;
        var fileId = _b.fileId, markers = _b.markers;
        var state = getState();
        setState(function (state) {
