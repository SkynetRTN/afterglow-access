...
exports.COMPONENTS = [cell_focuser_1.FocusableCell, cell_focuser_1.CellFocuser];
var UtilsModule = /** @class */ (function () {
  ...
  UtilsModule.forRoot = function () {
    return {
      ...
      providers: [correlated_action_1.CorrelationIdGenerator],
    };
  };
  var UtilsModule_1;
  UtilsModule = UtilsModule_1 = __decorate(
    [
      core_1.NgModule({
        imports: [router_1.RouterModule, common_1.CommonModule, forms_1.FormsModule, material_1.MaterialModule],
