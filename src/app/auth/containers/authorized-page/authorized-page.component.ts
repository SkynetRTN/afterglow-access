...
export class AuthorizedPageComponent implements OnInit, OnDestroy {
  ...
  constructor(private store: Store, private activatedRoute: ActivatedRoute, private router: Router, private authService: AuthService, private cookieService: CookieService) { }
